...
describe('Session State', () => {
  ...
  describe('createSession', () => {
    test('should create a new session', () => {
      ...
      createSession(sessions, 'token-123', { createdAt: Date.now(), ip: '127.0.0.1' }, TEST_SESSIONS_PATH);
  ...
  describe('getSessionAvatarState', () => {
    ...
    test('should return stored avatar state', () => {
      const sessions = new Map();
      createSession(sessions, 'token-abc', { createdAt: Date.now(), avatarState: 'working' }, TEST_SESSIONS_PATH);
  ...
  describe('Session persistence', () => {
    test('should persist and reload sessions', () => {
      ...
      createSession(sessions1, 'persist-test', { 
        createdAt: Date.now(), 
        avatarState: 'happy' 
      }, TEST_SESSIONS_PATH);
...
describe('Avatar State Values', () => {
  const validStates = ['idle', 'thinking', 'working', 'coding', 'talking', 'happy', 'error', 'sleeping'];
